    ...
    static public BlueprintSetting Instance {
        get {
            if (_instance == null) {
                ...
                if (_instance == null) {
                    _instance = new GameObject("BlueprintSetting").AddComponent<BlueprintSetting>();
                    PrefabUtility.SaveAsPrefabAsset(_instance.gameObject, "Assets/GameDesigner/Editor/Resources/BlueprintSetting.prefab");
                    _instance = Resources.Load<BlueprintSetting>("BlueprintSetting");
                }
            }
            return _instance;
