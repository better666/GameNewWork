                ...
                try {
                    ...
                    if (typeInfo.selectTypeIndex == 0 & !typeInfo.findTools) {
                        if (typeInfo.nameSpaces.Count == 0) {
                            typeInfo.nameSpaces = new List<string>();
                            SystemType.GetTypes(dataPath, types => {
                            ...
                            int n = 0;
                            for (int i = 0; i < typeInfo.nameSpaces.Count; ++i) {
                                if (typeInfo.nameSpaces[i] == "Assembly-CSharp") {
                                    string con = typeInfo.nameSpaces[0];
                                    typeInfo.nameSpaces[0] = typeInfo.nameSpaces[i];
                                    typeInfo.nameSpaces[i] = con;
                                }
                                if (typeInfo.nameSpaces[i] == "GameDesigner.FlowControls") {
                                    string con = typeInfo.nameSpaces[1];
                                    typeInfo.nameSpaces[1] = typeInfo.nameSpaces[i];
                                    typeInfo.nameSpaces[i] = con;
                                }
                                if (typeInfo.nameSpaces[i] == "GameDesigner.MathOperations") {
                                    string con = typeInfo.nameSpaces[2];
                                    typeInfo.nameSpaces[2] = typeInfo.nameSpaces[i];
                                    typeInfo.nameSpaces[i] = con;
                                }
                                if (typeInfo.nameSpaces[i] == "System") {
                                    string con = typeInfo.nameSpaces[3];
                                    typeInfo.nameSpaces[3] = typeInfo.nameSpaces[i];
                                    typeInfo.nameSpaces[i] = con;
                                }
                                if (typeInfo.nameSpaces[i] == "UnityEngine") {
                                    string con = typeInfo.nameSpaces[4];
                                    typeInfo.nameSpaces[4] = typeInfo.nameSpaces[i];
                                    typeInfo.nameSpaces[i] = con;
                                }
                                if (typeInfo.nameSpaces[i].Contains("UnityEngine")) {
                                    string saveSpace = typeInfo.nameSpaces[5 + n];
                                    typeInfo.nameSpaces[5 + n] = typeInfo.nameSpaces[i];
                                    typeInfo.nameSpaces[i] = saveSpace;
                                    n++;
                                }
                            }
                        }
