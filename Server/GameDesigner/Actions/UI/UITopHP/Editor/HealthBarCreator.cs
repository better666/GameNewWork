...
public class HealthBarCreator : EditorWindow {
	...
	static void Init()
	{
		HealthBarCreator cEditor = (HealthBarCreator)GetWindowWithRect(typeof(HealthBarCreator), new Rect(0,0, 400, 400), false, "X-BARS");
	}
	...
	private static void CreateEventSystem(bool select, GameObject parent)
	{
		...
		if (esys == null)
		{
			...
			//eventSystem.AddComponent<isTouchInputModule>();
