...
public class HealthBar : MonoBehaviour {
	...
	private Text healthInfo, playerInfo;			//Health info, a healthbar's child Text object(should be named as HealthInfo);
	...
	void Start () 
	{
        ...
        playerInfo = HealthbarPrefab.transform.Find("PlayerName").GetComponent<Text>();
        playerInfo.text = player.PlayerName;
	...
	void LateUpdate()
	{
		...
		healthInfo.rectTransform.sizeDelta = new Vector2 (HealthbarPrefab.sizeDelta.x * healthInfoSize/10, HealthbarPrefab.sizeDelta.y * healthInfoSize/10);

        playerInfo.rectTransform.sizeDelta = healthInfo.rectTransform.sizeDelta;

        healthInfoPosition.y = HealthbarPrefab.sizeDelta.y + (healthInfo.rectTransform.sizeDelta.y - HealthbarPrefab.sizeDelta.y) / 2;

        playerInfo.rectTransform.anchoredPosition = healthInfoPosition;
