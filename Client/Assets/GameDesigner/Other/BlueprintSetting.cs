...
public class BlueprintSetting : MonoBehaviour
{
	...
	public GUIStyle intStyle{
		get{
			if( _intStyle == null | initIntStyle ){
				...
				SetPropertyValue( _intStyle , GUI.skin.GetStyle( intStyleName ));
			}
			return _intStyle;
		}
	}
	...
	public GUIStyle floatStyle{
		get{
			if( _floatStyle == null | initFloatStyle ){
				...
				SetPropertyValue( _floatStyle , GUI.skin.GetStyle( floatStyleName ));
			}
			return _floatStyle;
		}
	}
	...
	public GUIStyle stringStyle{
		get{
			if( _stringStyle == null | initStringStyle ){
				...
				SetPropertyValue( _stringStyle , GUI.skin.GetStyle( stringStyleName ));
			}
			return _stringStyle;
		}
	}
	...
	public GUIStyle boolStyle{
		get{
			if( _boolStyle == null | initBoolStyle ){
				...
				SetPropertyValue( _boolStyle , GUI.skin.GetStyle( boolStyleName ));
			}
			return _boolStyle;
		}
	}
	...
	public GUIStyle vector2Style{
		get{
			if( _vector2Style == null | initVector2Style ){
				...
				SetPropertyValue( _vector2Style , GUI.skin.GetStyle( vector2StyleName ));
			}
	...
	public GUIStyle vector3Style{
		get{
			if( _vector3Style == null | initVector3Style ){
				...
				SetPropertyValue( _vector3Style , GUI.skin.GetStyle( vector3StyleName ));
			}
	...
	public GUIStyle vector4Style{
		get{
			if( _vector4Style == null | initVector4Style ){
				...
				SetPropertyValue( _vector4Style , GUI.skin.GetStyle( vector4StyleName ));
			}
	...
	public GUIStyle rectStyle{
		get{
			if( _rectStyle == null | initRectStyle ){
				...
				SetPropertyValue( _rectStyle , GUI.skin.GetStyle( rectStyleName ));
			}
			return _rectStyle;
		}
	}
	...
	public GUIStyle quaternionStyle{
		get{
			if( _quaternionStyle == null | initQuaternionStyle ){
				...
				SetPropertyValue( _quaternionStyle , GUI.skin.GetStyle( quaternionStyleName ));
			}
	...
	public GUIStyle colorStyle{
		get{
			if( _colorStyle == null | initColorStyle ){
				...
				SetPropertyValue( _colorStyle , GUI.skin.GetStyle( colorStyleName ));
			}
			return _colorStyle;
		}
	}
	...
	public GUIStyle animCurveStyle{
		get{
			if( _animCurveStyle == null | initAnimCurveStyle ){
				...
				SetPropertyValue( _animCurveStyle , GUI.skin.GetStyle( animCurveStyleName ));
			}
	...
	public GUIStyle enumStyle{
		get{
			if( _enumStyle == null | initEnumStyle ){
				...
				SetPropertyValue( _enumStyle , GUI.skin.GetStyle( enumStyleName ));
			}
			return _enumStyle;
		}
	}
	...
	public GUIStyle typeStyle{
		get{
			if( _typeStyle == null | initTypeStyle ){
				...
				SetPropertyValue( _typeStyle , GUI.skin.GetStyle( typeStyleName ));
			}
			return _typeStyle;
		}
	}
	...
	public GUIStyle nullStyle{
		get{
			if( _nullStyle == null | initNullStyle ){
				...
				SetPropertyValue( _nullStyle , GUI.skin.GetStyle( nullStyleName ));
			}
			return _nullStyle;
		}
	}
	...
	public Texture unityEngineImage{
		get{
			if(_unityEngineImage == null){
				return _unityEngineImage = GUI.skin.GetStyle("MeTransPlayhead").normal.background;
			}
	...
	public GUIStyle systemStyle{
		get{
			if( _systemStyle == null | initSystemStyle ){
				...
				SetPropertyValue( _systemStyle , GUI.skin.GetStyle( systemStyleName ));
			}
			return _systemStyle;
		}
	}
	...
	public Texture cshImage{
		get{
			if(_cshImage == null){
				return _cshImage = GUI.skin.GetStyle("MeTransPlayhead").normal.background;
			}
			return _cshImage;
		}
	}
	...
	public Texture stateMachineImage{
		get{
			if(_stateMachineImage == null){
				return _stateMachineImage = GUI.skin.GetStyle("MeTransPlayhead").normal.background;
			}
	...
	public GUIStyle stateMachineStyle{
		get{
			if( _stateMachineStyle == null | initStateMachineStyle ){
				...
				SetPropertyValue( _stateMachineStyle , GUI.skin.GetStyle( stateMachineStyleName ));
			}
    ...
    [Header("node选择方法皮肤")]
	public string selectMethodStyleName = "flow overlay box";
	...
	#endif
	public GameDesigner.SelectionObjModel selectObjModel = GameDesigner.SelectionObjModel.SelectionStateManager;
	public HideFlags StateHideFlags = HideFlags.None;
	/// 第一次打开蓝图编辑器窗口时自动初始化蓝图的dll引用与设置
	public GameDesigner.InitializeBlueprintEditorMode initializeBlueprintEditor = GameDesigner.InitializeBlueprintEditorMode.OpenBlueprintUpdate;
}